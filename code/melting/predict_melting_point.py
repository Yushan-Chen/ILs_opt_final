...
INPUT_FILE = '/home/ychen3338/project_2/code/melting/smiles_m.csv'
MODEL_FILE = '/home/ychen3338/project_2/code/melting/best_lgbm_model.pkl'
OUTPUT_FILE = '/home/ychen3338/project_2/data/after_m.csv'
FP_RADIUS = 4
FP_LENGTH = 54
THRESHOLD_K = 298.15
N_JOBS = 24
...
for i in range(num_batches):
    ...
    batch_df['m_pre'] = best_model.predict(X_pred)

    batch_filtered = batch_df[batch_df['m_pre'] < THRESHOLD_K][['IL_smile', 'm_pre']]
