...
IL_SMILES_PATH = '/home/ychen3338/project_2/data/after_m_tox_vis.csv'
OUTPUT_PATH = 'simles_co2.csv'
N_JOBS = 24
...
il_filtered = il_df[il_df['IL_smile'].isin(filtered_df['IL_smile'])][['IL_smile', 'm_pre','tox_pre','vis_pre']].drop_duplicates(subset='IL_smile')
